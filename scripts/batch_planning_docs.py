...
def extract_component_from_title(title: str) -> str:
    ...
    for suffix in ['- Design and Documentation', '- Write Tests', '- Implementation',
                   '- Integration and Packaging', '- Refactor and Finalize']:
...
def create_planning_doc(issue_number: int, issue_data: Dict) -> bool:
    ...
    # Create directory
    issue_dir = Path(f'/home/mvillmow/ml-odyssey-manual/notes/issues/{issue_number}')
