...
1. **CI/CD:** Pre-commit hooks and GitHub Actions install dependencies on every PR
1. **Runtime validation:** Tools fail immediately if dependencies are missing
1. **Setuptools validation:** Build system checks dependency resolution
