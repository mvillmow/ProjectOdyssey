# Issue #161: [Package] Write Quickstart

## Objective

Package phase for Write Quickstart component.
...
The package phase for Write Quickstart has been completed successfully. See related issues for
