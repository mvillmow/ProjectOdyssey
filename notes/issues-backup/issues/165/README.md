# Issue #165: [Impl] Write Structure

## Objective

Impl phase for Write Structure component.
...
The impl phase for Write Structure has been completed successfully. See related issues for
