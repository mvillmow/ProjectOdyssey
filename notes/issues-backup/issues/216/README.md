# Issue #216: [Package] Foundation

## Objective

Package phase for Foundation component.
...
The package phase for Foundation has been completed successfully. See related issues for
