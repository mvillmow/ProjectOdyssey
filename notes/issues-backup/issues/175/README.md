# Issue #175: [Impl] Write Workflow

## Objective

Impl phase for Write Workflow component.
...
The impl phase for Write Workflow has been completed successfully. See related issues for
