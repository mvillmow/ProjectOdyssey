# Issue #180: [Impl] Write Standards

## Objective

Impl phase for Write Standards component.
...
The impl phase for Write Standards has been completed successfully. See related issues for
