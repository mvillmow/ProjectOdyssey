# Issue #181: [Package] Write Standards

## Objective

Package phase for Write Standards component.
...
The package phase for Write Standards has been completed successfully. See related issues for
