...
**Plan Issue**:
- Title: [Plan] Correctness Reviewer - Design and Documentation
- Body:
```
## Planning Phase: Correctness Reviewer
...
**Test Issue**:
- Title: [Test] Correctness Reviewer - Write Tests
- Body:
```
## Testing Phase: Correctness Reviewer

### Objective
Write comprehensive tests following TDD principles for correctness reviewer.
...
- Title: [Impl] Correctness Reviewer - Implementation
- Body:
```
## Implementation Phase: Correctness Reviewer

### Objective
Implement correctness reviewer according to the design specifications and passing all tests.
...
**Packaging Issue**:
- Title: [Package] Correctness Reviewer - Integration and Packaging
- Body:
```
## Packaging Phase: Correctness Reviewer

### Objective
Package and integrate correctness reviewer into the broader system.
...
**Cleanup Issue**:
- Title: [Cleanup] Correctness Reviewer - Refactor and Finalize
- Body:
```
## Cleanup Phase: Correctness Reviewer

### Objective
Refactor, optimize, and finalize correctness reviewer for production readiness.
