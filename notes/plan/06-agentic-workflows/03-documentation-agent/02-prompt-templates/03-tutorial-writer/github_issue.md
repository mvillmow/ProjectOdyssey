...
**Plan Issue**:
- Title: [Plan] Tutorial Writer - Design and Documentation
- Body:
```
## Planning Phase: Tutorial Writer

### Objective
Create a prompt template for writing comprehensive tutorials. The template guides users through step-by-step instructions with clear explanations and working examples.

### Required Inputs
- Tutorial topic and learning objectives
...
**Test Issue**:
- Title: [Test] Tutorial Writer - Write Tests
- Body:
```
## Testing Phase: Tutorial Writer

### Objective
Write comprehensive tests following TDD principles for tutorial writer.
...
- Title: [Impl] Tutorial Writer - Implementation
- Body:
```
## Implementation Phase: Tutorial Writer

### Objective
Implement tutorial writer according to the design specifications and passing all tests.
...
**Packaging Issue**:
- Title: [Package] Tutorial Writer - Integration and Packaging
- Body:
```
## Packaging Phase: Tutorial Writer

### Objective
Package and integrate tutorial writer into the broader system.
...
**Cleanup Issue**:
- Title: [Cleanup] Tutorial Writer - Refactor and Finalize
- Body:
```
## Cleanup Phase: Tutorial Writer

### Objective
Refactor, optimize, and finalize tutorial writer for production readiness.
...
### Additional Notes
Include sections: introduction with objectives, prerequisites, step-by-step instructions, code examples with explanations, common issues and solutions, next steps. Use XML tags like <tutorial>, <objective>, <step>, <example>. Keep explanations clear and beginner-friendly.
