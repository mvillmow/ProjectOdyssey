...
**Plan Issue**:
- Title: [Plan] First Paper - Model Implementation - Model Tests - Test Shapes - Design and Documentation
- Body:
```
## Objective

Design and document the approach for: **03: Test Shapes**
...
**Test Issue**:
- Title: [Test] First Paper - Model Implementation - Model Tests - Test Shapes - Write Tests
- Body:
```
## Objective

Write comprehensive tests for: **03: Test Shapes**
...
- Title: [Impl] First Paper - Model Implementation - Model Tests - Test Shapes - Implementation
- Body:
```
## Objective

Implement: **03: Test Shapes**
...
**Packaging Issue**:
- Title: [Package] First Paper - Model Implementation - Model Tests - Test Shapes - Integration and Packaging
- Body:
```
## Objective

Package and integrate: **03: Test Shapes**
...
**Cleanup Issue**:
- Title: [Cleanup] First Paper - Model Implementation - Model Tests - Test Shapes - Refactor and Finalize
- Body:
```
## Objective

Refactor, optimize, and finalize: **03: Test Shapes**
