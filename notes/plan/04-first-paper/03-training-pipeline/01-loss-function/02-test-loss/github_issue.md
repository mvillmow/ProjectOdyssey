...
**Plan Issue**:
- Title: [Plan] First Paper - Training Pipeline - Loss Function - Test Loss - Design and Documentation
- Body:
```
## Objective

Design and document the approach for: **02: Test Loss**

## Overview

Write comprehensive tests for the loss function to verify correctness with known inputs and edge cases.
...
- Test with perfect predictions (loss ≈ 0)
- Test with random predictions
- Test with one-hot labels
- Verify gradient computation later

## Links

**Parent**: [01-loss-function](../plan.md)
...
**Test Issue**:
- Title: [Test] First Paper - Training Pipeline - Loss Function - Test Loss - Write Tests
- Body:
```
## Objective

Write comprehensive tests for: **02: Test Loss**
...
- [ ] Loss tests pass
- [ ] Known cases produce correct loss
...
- Title: [Impl] First Paper - Training Pipeline - Loss Function - Test Loss - Implementation
- Body:
```
## Objective

Implement: **02: Test Loss**
...
**Packaging Issue**:
- Title: [Package] First Paper - Training Pipeline - Loss Function - Test Loss - Integration and Packaging
- Body:
```
## Objective

Package and integrate: **02: Test Loss**
...
**Cleanup Issue**:
- Title: [Cleanup] First Paper - Training Pipeline - Loss Function - Test Loss - Refactor and Finalize
- Body:
```
## Objective

Refactor, optimize, and finalize: **02: Test Loss**
