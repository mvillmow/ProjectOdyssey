...
**Title**: `[Plan] README - Design and Documentation`
...
## Objective
Design and document the approach for implementing **README**.

## Overview
Write a comprehensive README.md that serves as the main entry point for the repository. Include project overview, quickstart guide, and repository structure explanation to help users and contributors understand the project quickly.
...
- Project goals and purpose are defined
...
## Additional Context
The README is the first thing people see. Make it clear, welcoming, and informative. Focus on helping people understand what the project does and how to get started.
...
## Objective
Write comprehensive tests for **README** following Test-Driven Development (TDD) principles.
...
- [ ] Structure documentation helps navigate repository
...
**Title**: `[Impl] README - Implementation`
...
## Objective
Implement the functionality for **README** according to the plan and make all tests pass.
...
**Title**: `[Package] README - Integration and Packaging`
...
## Objective
Package and integrate **README** into the codebase.
...
**Title**: `[Cleanup] README - Refactor and Finalize`
...
## Objective
Refactor, optimize, and finalize **README** to ensure production readiness.
