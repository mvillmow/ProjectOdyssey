...
**Title**: `[Plan] Create Core - Design and Documentation`
...
## Objective
Design and document the approach for implementing **Create Core**.
...
**Title**: `[Test] Create Core - Write Tests`
...
## Objective
Write comprehensive tests for **Create Core** following Test-Driven Development (TDD) principles.
...
**Title**: `[Impl] Create Core - Implementation`
...
## Objective
Implement the functionality for **Create Core** according to the plan and make all tests pass.
...
**Title**: `[Package] Create Core - Integration and Packaging`
...
## Objective
Package and integrate **Create Core** into the codebase.
...
**Title**: `[Cleanup] Create Core - Refactor and Finalize`
...
## Objective
Refactor, optimize, and finalize **Create Core** to ensure production readiness.
