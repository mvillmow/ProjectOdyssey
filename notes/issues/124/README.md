...
2. **Dependency resolution:** setuptools checks all dependencies are resolvable
3. **Pre-commit validation:** `check-yaml` hook validates TOML syntax
4. **CI/CD validation:** GitHub Actions install from pyproject.toml on every PR
