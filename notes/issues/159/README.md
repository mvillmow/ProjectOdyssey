# Issue #159: [Test] Write Quickstart

## Objective

Test phase for Write Quickstart component.
...
The test phase for Write Quickstart has been completed successfully. See related issues for
