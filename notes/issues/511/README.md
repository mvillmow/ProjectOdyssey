...
Write comprehensive test cases to validate that skills load correctly, activate appropriately, and
function as expected when invoked by agents or directly.
