...
## Objective
Create the `.claude/skills/` directory to house Claude Code Skills - reusable, autonomous capabilities that extend Claude's functionality through model-invoked patterns. Skills complement the agent system by providing algorithmic operations.
...
Key distinction: Skills run in current context and are model-invoked automatically, while sub-agents have separate conversation contexts and make complex decisions.
