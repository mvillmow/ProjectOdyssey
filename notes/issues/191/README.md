# Issue #191: [Package] Contributing

## Objective

Package phase for Contributing component.
...
The package phase for Contributing has been completed successfully. See related issues for
