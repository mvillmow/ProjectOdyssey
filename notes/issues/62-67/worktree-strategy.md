...
This document defines the git worktree strategy for implementing the multi-level agent hierarchy across issues 62-67 (agents/tools) and the new issues 68-73 (skills).
