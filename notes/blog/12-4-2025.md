# Day Seventeen: Lazy Updates and Hidden Progress
...
I've been de-duplicating code this week, and the amount of reduction has been pretty significant, but there still seems to be more code duplication that can be cleaned up. I'm also thinking of pulling ExTensor out into its own repository and just exposing the package and interface to ml-odyssey just to reduce the amount of changes that occur.
