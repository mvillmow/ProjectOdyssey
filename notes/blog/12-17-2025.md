...
**Key insight:** Tensor slicing is deceptively complex—handling negative indices, step sizes, and multi-dimensional slices correctly requires careful implementation.
