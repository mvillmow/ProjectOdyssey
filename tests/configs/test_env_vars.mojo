...
fn test_substitute_simple_env_var() raises:
    ...
    _ = python.environ.__setitem__(key="TEST_VAR", value="test_value")
...
fn test_substitute_multiple_env_vars() raises:
    ...
    """
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="BASE_DIR", value="/home/user")
    _ = python.environ.__setitem__(key="DATA_FOLDER", value="datasets")
...
fn test_substitute_env_var_in_middle() raises:
    ...
    """
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="MODEL_NAME", value="lenet5")
...
fn test_substitute_with_default_when_var_exists() raises:
    ...
    """
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="DATA_DIR", value="/actual/data")
...
fn test_substitute_preserves_non_string_values() raises:
    ...
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="HOME", value="/home/user")
...
fn test_load_and_substitute_training_config() raises:
    ...
    """
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="EXPERIMENT_NAME", value="baseline_001")
    _ = python.environ.__setitem__(key="OUTPUT_PATH", value="/results")
...
fn test_substitute_with_merge() raises:
    ...
    """
    var python = Python.import_module("os")
    _ = python.environ.__setitem__(key="BASE_LR", value="0.01")
