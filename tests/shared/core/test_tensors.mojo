...
fn test_tensor_dim() raises:
    ...
    var shape3 = DynamicVector[Int](4)
    shape3[0] = 2
    shape3[1] = 3
    shape3[2] = 4
    shape3[3] = 5
...
fn test_high_dimensional_tensor() raises:
    ...
    # 4D tensor
    var shape4 = DynamicVector[Int](4)
    shape4[0] = 2
    shape4[1] = 3
    shape4[2] = 4
    shape4[3] = 5
    ...
    # 5D tensor
    var shape5 = DynamicVector[Int](5)
    for i in range(5):
        shape5[i] = 2
