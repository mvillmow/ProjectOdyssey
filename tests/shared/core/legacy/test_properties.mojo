...
fn test_numel_scalar() raises:
    ...
    var shape = List[Int]()
    let t = full(shape, 1.0, DType.float32)
...
fn test_contiguous_1d() raises:
    ...
    var shape = List[Int]()
    shape.append(100)
    let t = arange(0.0, 100.0, 1.0, DType.float32)
...
fn test_full_pattern() raises:
    ...
    shape.append(2)
    shape.append(4)
    let t = full(shape, 7.5, DType.float32)
