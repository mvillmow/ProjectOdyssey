...
fn test_initialization():
    ...
    var result = BenchmarkResult("test_op", iterations=100)
...
fn test_record_single_iteration():
    """Test recording a single iteration."""
    var result = BenchmarkResult("single_test", iterations=1)
    result.record(5000)
...
fn test_record_multiple_iterations():
    ...
    var result = BenchmarkResult("constant_test", iterations=10)
