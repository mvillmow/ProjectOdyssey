...
from shared.training.dtype_utils import (
    float16_dtype, float32_dtype, float64_dtype, bfloat16_dtype,
    is_reduced_precision, is_floating_point,
    get_dtype_precision_bits, get_dtype_exponent_bits,
    dtype_to_string, recommend_precision_dtype
)
...
fn test_dtype_aliases() raises:
    ...
    assert_equal(float16_dtype, DType.float16, "float16_dtype should be DType.float16")
    assert_equal(float32_dtype, DType.float32, "float32_dtype should be DType.float32")
    assert_equal(float64_dtype, DType.float64, "float64_dtype should be DType.float64")

    # BFloat16 currently aliases to float16
    assert_equal(bfloat16_dtype, DType.float16, "bfloat16_dtype should currently alias to DType.float16")
...
fn test_is_reduced_precision() raises:
    ...
    assert_true(is_reduced_precision(DType.float16), "FP16 should be reduced precision")
    assert_false(is_reduced_precision(DType.float32), "FP32 should not be reduced precision")
    assert_false(is_reduced_precision(DType.float64), "FP64 should not be reduced precision")
    assert_false(is_reduced_precision(DType.int32), "Int32 should not be reduced precision")
...
fn test_is_floating_point() raises:
    ...
    assert_true(is_floating_point(DType.float16), "FP16 should be floating point")
    assert_true(is_floating_point(DType.float32), "FP32 should be floating point")
    assert_true(is_floating_point(DType.float64), "FP64 should be floating point")
    assert_false(is_floating_point(DType.int32), "Int32 should not be floating point")
    assert_false(is_floating_point(DType.uint8), "UInt8 should not be floating point")
...
fn test_get_dtype_precision_bits() raises:
    ...
    assert_equal(get_dtype_precision_bits(DType.float16), 10, "FP16 should have 10 mantissa bits")
    assert_equal(get_dtype_precision_bits(DType.float32), 23, "FP32 should have 23 mantissa bits")
    assert_equal(get_dtype_precision_bits(DType.float64), 52, "FP64 should have 52 mantissa bits")
    assert_equal(get_dtype_precision_bits(DType.int32), 0, "Int32 should return 0 mantissa bits")
...
fn test_get_dtype_exponent_bits() raises:
    ...
    assert_equal(get_dtype_exponent_bits(DType.float16), 5, "FP16 should have 5 exponent bits")
    assert_equal(get_dtype_exponent_bits(DType.float32), 8, "FP32 should have 8 exponent bits")
    assert_equal(get_dtype_exponent_bits(DType.float64), 11, "FP64 should have 11 exponent bits")
    assert_equal(get_dtype_exponent_bits(DType.int32), 0, "Int32 should return 0 exponent bits")
...
fn test_dtype_to_string() raises:
    ...
    assert_equal(dtype_to_string(DType.float16), "float16", "FP16 should be 'float16'")
    assert_equal(dtype_to_string(DType.float32), "float32", "FP32 should be 'float32'")
    assert_equal(dtype_to_string(DType.float64), "float64", "FP64 should be 'float64'")
    assert_equal(dtype_to_string(DType.int32), "int32", "Int32 should be 'int32'")
    assert_equal(dtype_to_string(DType.uint8), "uint8", "UInt8 should be 'uint8'")
...
fn test_bfloat16_alias_behavior() raises:
    ...
    var tensor = ExTensor.zeros(DynamicVector[Int](10), bfloat16_dtype)
