"""Linear regression example using improved functional autograd.
...
fn linear_regression_improved() raises:
    """Train a simple linear model using improved functional autograd helpers.

    This demonstrates the recommended approach with minimal boilerplate.
    """
    print("=== Linear Regression with Improved Autograd ===\n")
    ...
    for epoch in range(num_epochs):
        ...
        var predictions = ExTensor(DynamicVector[Int](5), DType.float32)
        for i in range(5):
